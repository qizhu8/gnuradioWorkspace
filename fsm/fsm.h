...
namespace gr {
  namespace trellis {
    ...
    public:
       ...
       *
       * \param k      number of input bits
       * \param n      number of output bits
       * \param G      A vector representation of the generator matrix of the code
       *
       */
       ...
       *
       * \param P    the denominator of the frequency sensitivity h=K/P (relatively prime)
